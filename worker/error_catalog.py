...
# User value: supports _is_gcs_connection_error so the OCR/transcription journey stays clear and reliable.
...
# User value: supports classify_error so the OCR/transcription journey stays clear and reliable.
