...
def build_dead_letter_entry(
    *,
    ...
    return {
        ...
        "recovery_attempt": _to_int(job.get("recovery_attempt"), 0),
        "recovery_max_attempts": _to_int(job.get("recovery_max_attempts"), 0),
        "recovery_trace": str(job.get("recovery_trace") or ""),
